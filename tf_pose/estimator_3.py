...
#Setup from https://eqs.github.io/post/python-osc/
...
##for k in range(5):
##while True:
##    msg = OscMessageBuilder(address='/nose')
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                position_values[i] = (int(body_part.x * image_w + 0.5),
...
#Reference From https://eqs.github.io/post/python-osc/

#Success Ver.1
#            msg = OscMessageBuilder(address='/nose')
#            msg.add_arg(str(position_values[0]))

#Success Ver.2
                msg = OscMessageBuilder(address='/' + body_parts_name[i])
                msg.add_arg(str(position_values))
                m = msg.build()    #Added

#Ver.3
#            for  in range(body_parts_name):
#                msg = OscMessageBuilder(address='/' + body_parts_name[i])    #Added
#                msg.add_arg(str(position_values))    #Added
#                m = msg.build()    #Added
...
#            client.send(m)
                ...
                print(m.address, m.params)    #Added
                client.send(m)    #Added
